...
//        self.backgroundColor = [UIColor whiteColor];
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kImageSize, kImageSize)];
        ...
        [_deleteBtn setImage:[UIImage imageNamed:@"button_cancel"] forState:UIControlStateNormal];
        _deleteBtn.frame = CGRectMake(kImageSize - 20, 0, 20, 20);
...
//    cellSnapshotView.frame = CGRectMake(0, 0, cellSnapshotView.frame.size.width, cellSnapshotView.frame.size.height);
    ...
    snapshotView.frame = CGRectMake(0, 0, kImageSize, kImageSize);
    cellSnapshotView.frame = CGRectMake(0, 0, kImageSize, kImageSize);
